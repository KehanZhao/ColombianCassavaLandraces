# Filter VCF -------------------------------------------------------------------
accession_info <- read.csv("S1_Cassava_accessions_meta_information.csv")
...
write(Wild_noHuKistler, "Wild_noHuKistler.txt")
write(South_america_breeding_noHuKistler, "South_america_breeding_noHuKistler.txt")
write(Colombia_landraces, "Colombia_landraces.txt")
write(Africa_breeding, "Africa_breeding.txt")


# Run VCF filtering and LD calculation using Plink on HPC

# LD Decay ---------------------------------------------------------------------
Colombia_landraces_LD <- read.table("Colombia_landraces_accesions_filtered_window100kb_thincount50000_may2025.ld", header = TRUE)
South_America_breeding_noHuKistler_LD <- read.table("South_america_breeding_noHuKistler_accesions_filtered_window100kb_thincount50000_may2025.ld", header = TRUE)
Africa_breeding_LD <- read.table("Africa_breeding_accesions_filtered_window100kb_thincount50000_may2025.ld", header = TRUE)
Wild_noHuKistler_LD <- read.table("Wild_noHuKistler_accesions_filtered_window100kb_thincount50000_may2025.ld", header = TRUE)
...
pdf("Figure1c_LD_decay_100kb_thincount50000_may2025_v2.pdf", width=2.4, height=2)

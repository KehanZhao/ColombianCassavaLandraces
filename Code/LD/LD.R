...
Wild<-accession_info$ID[which(accession_info$Biological.status=="Wild" | accession_info$Biological.status=="Other Manihot")]
...
write(Wild, '/Users/kehan/Library/CloudStorage/OneDrive-UniversityofCalifornia,Davis/Monroe_Lab/Cassava_Center/Accession_list_filtering/Wild.txt')
...
write(South_america_breeding, '/Users/kehan/Library/CloudStorage/OneDrive-UniversityofCalifornia,Davis/Monroe_Lab/Cassava_Center/Accession_list_filtering/South_america_breeding.txt')
...
write(South_america_breeding_noHu, '/Users/kehan/Library/CloudStorage/OneDrive-UniversityofCalifornia,Davis/Monroe_Lab/Cassava_Center/Accession_list_filtering/South_america_breeding_noHu.txt')
...
write(Esculenta_noHu, '/Users/kehan/Library/CloudStorage/OneDrive-UniversityofCalifornia,Davis/Monroe_Lab/Cassava_Center/Accession_list_filtering/Esculenta_noHu.txt')
...
South_America_breeding_LD<-read.table("/Users/kehan/Library/CloudStorage/OneDrive-UniversityofCalifornia,Davis/Monroe_Lab/Cassava_Center/Code/LD/LD_Decay/South_america_breeding_accesions_filtered_window100kb_thincount50000_may2025.ld",header = TRUE)
...
South_America_breeding_noHu_LD<-read.table("/Users/kehan/Library/CloudStorage/OneDrive-UniversityofCalifornia,Davis/Monroe_Lab/Cassava_Center/Code/LD/LD_Decay/South_america_breeding_noHu_accesions_filtered_window100kb_thincount50000_may2025.ld",header = TRUE)
...
Wild_LD<-read.table("/Users/kehan/Library/CloudStorage/OneDrive-UniversityofCalifornia,Davis/Monroe_Lab/Cassava_Center/Code/LD/LD_Decay/Wild_accesions_filtered_window100kb_thincount50000_may2025.ld",header = TRUE)
...
South_America_breeding_LD$Distance <- abs(as.numeric(South_America_breeding_LD$BP_B) - as.numeric(South_America_breeding_LD$BP_A))
South_America_breeding_LD$R2<-as.numeric(South_America_breeding_LD$R2)
...
South_America_breeding_noHu_LD$Distance <- abs(as.numeric(South_America_breeding_noHu_LD$BP_B) - as.numeric(South_America_breeding_noHu_LD$BP_A))
South_America_breeding_noHu_LD$R2<-as.numeric(South_America_breeding_noHu_LD$R2)
...
Wild_LD$Distance <- abs(as.numeric(Wild_LD$BP_B) - as.numeric(Wild_LD$BP_A))
Wild_LD$R2<-as.numeric(Wild_LD$R2)
...
library(ggplot2)
library(data.table)
# Combined plot with three smoothed curves
Colombia_landraces_LD$src<-"Colombian landraces"
Africa_breeding_LD$src<-"African breeding lines"
South_America_breeding_LD$src<-"South American breeding lines"
South_America_breeding_noHuKistler_LD$src<-"South American breeding lines (no Hu & Kistler)"
South_America_breeding_noHu_LD$src<-"South American breeding lines (no Hu)"
Wild_LD$src<-"Wild"
Wild_noHuKistler_LD$src<-"Wild_noHuKistler"
all_LD<-rbindlist(list(Colombia_landraces_LD, Africa_breeding_LD, South_America_breeding_LD, South_America_breeding_noHuKistler_LD, South_America_breeding_noHu_LD, Wild_LD, Wild_noHuKistler_LD))
all_LD$src <- factor(all_LD$src, 
                     levels = c("Colombian landraces", 
                                ...
                                "South American breeding lines (no Hu)",
                                "Wild",
                                "Wild_noHuKistler"))

pdf("/Users/kehan/Library/CloudStorage/OneDrive-UniversityofCalifornia,Davis/Monroe_Lab/Cassava_Center/Figures/Figures_for_publication/Figure1c_LD_decay_100kb_thincount50000_may2025.pdf", width=2.4, height=2)
ggplot(all_LD, aes(x = Distance, y = R2, col = src)) +
  geom_smooth(method = "auto") +
  labs(x = "Distance (bp)", y = "R²") +
  scale_color_manual(name = "Category", 
                     values = c("Colombian landraces" = "#319aa1", 
                                "African breeding lines" = "#541353", 
                                "South American breeding lines" = "#ffcf21",
                                "South American breeding lines (no Hu & Kistler)" = "red",
                                "South American breeding lines (no Hu)" = "pink",
                                "Wild" = "#12a63d",
                                "Wild" = "grey"),
                     labels = c("Colombian landraces", "African breeding lines", "South American breeding lines", "South American breeding lines (no Hu & Kistler)", "South American breeding lines (no Hu)", "Wild relatives", "Wild (no Hu & Kistler)")) +

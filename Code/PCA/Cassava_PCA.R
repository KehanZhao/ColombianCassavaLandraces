...
# Load results
library(data.table)
PCA_result <- fread("All_accessions_withKistler_noHerbarium_filtered_Qual30_maf5pct_xgboost.eigenvec")
...
eigenValues <- read.delim("All_accessions_withKistler_noHerbarium_filtered_Qual30_maf5pct_xgboost.eigenval", sep = " ", header = F)
...
pdf("Figure1a_PCA_All_PC1&2_recolored_withKistler_noHerbarium.pdf", width=2.3, height=2)
...
eigenValues <- read.delim("Esculenta_accesions_withKistler_noHerbarium_filtered.eigenval", sep = " ", header = F)
...
pdf("Figure1b_PCA_Esculenta_PC1&2_recolored_withKistler_noHerbarium_v2.pdf", width=2.3, height=2)
ggplot(data = PCA_result) +

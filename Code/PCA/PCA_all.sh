...
vcftools \
  --gzvcf $VCF_DIR/combined_cassava_mar2025_final_withKistler_noHerbarium_chrrenamed.vcf.gz \
  --minQ 30 \
...
plink \
  --vcf $VCF_DIR/All_accessions_noHerbarium_filtered_Qual30_maf5pct_xgboost.vcf \
  --chr 1-18 --make-bed --double-id --vcf-half-call missing --allow-extra-chr \
  --out $VCF_DIR/All_accessions_noHerbarium_filtered_Qual30_maf5pct_xgboost

# PCA
plink \
  --bfile $VCF_DIR/All_accessions_noHerbarium_filtered_Qual30_maf5pct_xgboost \
  --pca --out ./PCA_output/All_accessions_withKistler_noHerbarium_filtered_Qual30_maf5pct_xgboost
